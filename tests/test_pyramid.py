...
class PyramidTest(unittest.TestCase):
    ...
    def setUp(self):
        s1 = Star(0,0,None,None,0,0)
        s2 = Star(1,0,None,None,np.pi/3,0)
        s3 = Star(2,0,None,None,0,np.pi/6)
        self.scene = Scene([s1,s2,s3])

    def test_find_matching_triplets(self):
        ms1 = Star(3,0,None,None,np.pi,0)
        ms2 = Star(4,0,None,None,4*np.pi/3,0)
        ms3 = Star(5,0,None,None,np.pi,np.pi/6)
        ms4 = Star(6,0,None,None,5*np.pi/6,0)
        ms5 = Star(7,0,None,None,np.pi,np.pi/2)
        ms6 = Star(8,0,None,None,np.pi/2,np.pi/6)
    ...
    def test_find_matching_triplets_many(self):
        ...
        ms2 = Star(4,0,None,None,4*np.pi/3,0)
        ms3 = Star(5,0,None,None,np.pi,np.pi/6)
        ms4 = Star(6,0,None,None,2*np.pi/3,0)
    ...
    def test_find_matching_triplets_none(self):
        ms1 = Star(3,0,None,None,np.pi,0)
        ms2 = Star(4,0,None,None,4*np.pi/3,0)
        ms3 = Star(5,0,None,None,np.pi,np.pi/6+0.001)
